				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-pricing <?php echo (get_post_meta($row->ID, '_is_it_feature', true)=='yes'?'special-single-price': ''); ?> ">
						...
						<div class="pricing-body">
								...
								<?php	$aw=0;
									for($i=0;$i<20;$i++){
										...
										<div class="single-pricing-details clearfix">
											<div class="spd-left">
												<i class="fa <?php echo get_post_meta($row->ID,'feature_icon_'.$i,true);?>"></i>
											</div>
											<div class="spd-right">
												<p>
							...
							<a class="btn btn-primary pricing-buy-now" href="<?php echo get_page_link($page_name_reg).'?&package_id='.esc_attr($row->ID); ?>"><?php esc_html_e('BUY NOW','jobboard'); ?></a>
