<div class="row form-group">
	<label for="text" class="col-md-4"><?php  esc_html_e('Package Name','jobboard');?></label>
	<div class="col-md-8">
		<?php
			$recurring_text='';
			...
			if( $package_name==""){
				...
				if(sizeof($membership_pack)>0){
					...
					if($recurring == 'on'){
						$package_amount=get_post_meta($package_id, 'jobboard_package_recurring_cost_initial', true).' '.$api_currency.'/'.get_post_meta($package_id, 'jobboard_package_recurring_cycle_count', true).' '.get_post_meta($package_id, 'jobboard_package_recurring_cycle_type', true);
						}else{
						$package_amount=get_post_meta($package_id, 'jobboard_package_cost',true).' '.$api_currency;
					}
				?>
				<?php
				}
...
<div class="row form-group">
	<label for="text" class="col-md-4"><?php  esc_html_e('Amount','jobboard');?></label>
...
<div class="row">
	...
	<div class="col-md-8 ">
		...
		if($eprecaptcha_api==''){
			?>
				<button  id="submit_jobboard_payment" name="submit_jobboard_payment"  type="submit" class="btn btn-secondary"  > <?php  esc_html_e('Submit','jobboard');?></button>	
		<?php
		}else{
		?>
