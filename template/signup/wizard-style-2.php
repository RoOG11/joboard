<?php
	...
	wp_enqueue_style('bootstrap-wp-jobboard-style-signup-11', wp_jobboard_URLPATH . 'admin/files/css/iv-bootstrap-4.css');
				...
				<div id="employer-div">
					<div class="row light-bg">
						<div class="col-md-10 header-profile">
							<h4 class="my-auto"><?php   esc_html_e('Payment Info','jobboard');?></h4>
						</div>
					</div>
					<div class="row payment_info">
						<div class="col-md-10 mx-auto">
							<?php
								if($iv_gateway=='paypal-express'){
									include(wp_jobboard_template.'signup/paypal_form_2.php');
								}
								if($iv_gateway=='stripe'){
									include(wp_jobboard_template.'signup/iv_stripe_form_2.php');
								}
								if($iv_gateway=='woocommerce'){
									include(wp_jobboard_template.'signup/woocommerce.php');
								}
							?>
						</div>
					</div>
