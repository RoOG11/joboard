<?php
	...
	wp_enqueue_style('wp-jobboard-public-111', wp_jobboard_URLPATH .'admin/files/css/iv-bootstrap-4.css');
				...
				<div class="item-detail-special contentshowep">
					<div class="col-md-2 ">
						<?php
							...
							<img  width="80px" src="<?php echo esc_url($iv_profile_pic_url); ?>">
							<?php
								}else{
								echo'	 <img width="80px" src="'. wp_jobboard_URLPATH.'assets/images/company-enterprise.png">';
							}
						?>
					</div>
						<div class="col-md-7">
							<div class="align-items-lg-center">							
								<h2 class="title-detail"><?php echo get_user_meta($user_id,'full_name',true); ?></h2>
									<?php
									...
									<div class="meta-job">
										...
										?>
										<span class="website"><i class="fa fa-link"></i><a href="<?php echo esc_url(get_user_meta($user_id,'website',true)); ?>" target="_blank"><?php echo get_user_meta($user_id,'website',true); ?></a></span>
										...
										<?php
											...
											?>
											<span class="phone"><i class="fa fa-mobile-alt"></i><?php echo get_user_meta($user_id,'phone',true); ?></span>
											<?php
											}
										?>
										<?php
							...
							<div class="sidebar-right-group">
								<div class="job-detail-summary">
									...
									<li class="row">
										...
										<div class="col-5 col-md-6 px-0"><?php echo get_user_meta($user_id,'company_type',true);?></div>
									</li>
