					...
					<div class="col-md-2 ">
						<?php
							...
							<?php
								...
								echo'<img width="80px" src="'. wp_jobboard_URLPATH.'assets/images/default-user.png">';
							}
						?>
					</div>
					<div class="col-md-7">
						<div class="row align-items-lg-center">
							<div class="col-lg-7 col-xl-8 ">
								...
								<?php
									...
									?>
									<div class="date-job">
									<?php echo get_user_meta($user_id,'qualification',true); ?>
									</div>
								<?php
								}
							?>
								...
								<?php					   
									for($i=0;$i<20;$i++){
										...
										<div class="item-list">
											...
											echo get_user_meta($user_id,'eduenddate'.$i,true); ?></span></p>
											<div class="item-title">
												<p><?php echo esc_html(get_user_meta($user_id,'educationtitle'.$i,true)); ?><span class="item-position">- <?php
												echo get_user_meta($user_id,'institute'.$i,true); ?></span></p>
											</div>
											<div class="item-text">
												<p>
													<?php
								...
								<?php			
									for($i=0;$i<30;$i++){
										...
										<div class="item-list">										
											...
											<div class="item-text">
												<p><?php
												echo get_user_meta($user_id,'award_description'.$i,true); ?></p>
											</div>
											</div>
										</div>
												...
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															<label><?php echo get_user_meta($user_id,'language'.$i,true); ?></label>
