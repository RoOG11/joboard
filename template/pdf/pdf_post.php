<?php
	if(isset($_REQUEST['jobboardpdfpost'])){ 
		...
		<td scope="row" style="text-align: left;width:50%"><h2>'. $name_display .'</h2><br/>'.$address.' <br/> '.$client_email_address.'<br/>'. esc_html__('Phone','jobboard').' : '.esc_attr($phone).'  <br/> '. esc_html__('Web','jobboard').' : '.$web.'</td>	
