  ...
  <div id="login-2" class="bootstrap-wrapper">
   ...
   <div class="content-real">
    ...
    <form id="login_form" class="login-form" action="" method="post">
      ...
      <div class="col-md-4">
        <button type="button" class="btn btn-custom uppercase pull-left" onclick="return chack_login();" ><?php   esc_html_e('Login','jobboard');?></button>
      </div>
    ...
    <div class="create-account">
          <p><?php
			$iv_redirect = get_option('epjbjobboard_price_table');
