									...
									<div class="row align-items-center">										
										<div class="col-md-12 job-info px-0">
											<div class="text px-0 text-left">	
												...
												<div class="title-job"><span class="location"><i class="far fa-envelope"></i><span class="p-2"><?php  echo get_post_meta( $id, 'from_email', true); ?></span></span> <i class="fas fa-phone-volume"></i><span class="p-2"> <?php  esc_html_e('Phone','jobboard');?> : <?php echo esc_attr(get_post_meta($id,'from_phone',true)); ?></span></div>	
												<?php
