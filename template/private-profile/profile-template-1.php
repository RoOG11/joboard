<?php
	...
	wp_enqueue_style('bootstrap-css-jobboard-ep7', wp_jobboard_URLPATH . 'admin/files/css/iv-bootstrap-4.css');
				...
				<div class="company_img">
					<?php
						...
						<?php
							...
							echo'<img src="'. wp_jobboard_URLPATH.'admin/files/images/thumb100x100.png">';
						}
					?>
				</div>
