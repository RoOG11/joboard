<?php
	...
	wp_enqueue_style('bootstrap-style-11', wp_jobboard_URLPATH . 'admin/files/css/iv-bootstrap-4.css');
											...
											<?php
												...
												if(isset($_REQUEST['category_input'])){													
													...
													foreach($category_input_array1 as $cat_one){
														$category_input_array[]=esc_attr($cat_one);
													}													
												}	
						...
						<?php				
							...
							if( isset($_REQUEST['category_input'])){								
								if($_REQUEST['category_input']!=""){
									$categories_arr=$_REQUEST['category_input'];
									$categories_arr = array_map( 'sanitize_text_field', $categories_arr );
													...
													<div class="row">
														...
														<?php
															if(get_user_meta($user->ID,'qualification',true)!=''){
																...
																<?php echo get_user_meta($user->ID,'qualification',true); ?></p>
																</p>
															<?php
															}
															?>
															...
															<?php
																...
																?>	
																<p class="cost"><i class="far fa-money-bill-alt"></i> <?php echo get_user_meta($user->ID,'hourly_rate',true); ?></p>
																<?php
																}
																?>
														</div>
