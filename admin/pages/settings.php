		...
		<div class="panel with-nav-tabs panel-info">
			...
			<div class="panel-heading">
				<ul class="nav nav-tabs">
					...
					<li ><a href="#all-package" data-toggle="tab"><?php  esc_html_e('Package','jobboard'); ?></a></li>
					...
					<li ><a href="#email" data-toggle="tab"><?php  esc_html_e('Email','jobboard'); ?> </a></li>								
					<li ><a href="#mailchimp" data-toggle="tab"><?php  esc_html_e('MailChimp','jobboard'); ?> </a></li>
				</ul>
			</div>
			<div class="panel-body">
				<div class="tab-content">	
					...
					<div class="tab-pane" id="all-package">								
						<?php
							require(wp_jobboard_DIR .'/admin/pages/package_all.php');
						?>
					</div>
					...
					<div class="tab-pane" id="payment-gateway">								
						<?php
							require(wp_jobboard_DIR .'/admin/pages/payment-settings.php');
						?>
					</div>
					...
					<div class="tab-pane " id="mailchimp">
						<div class="form-group  row">
							<label  class="col-md-3  control-label"> </label>
							<div class="col-md-4">
								<button type="button" onclick="return  iv_update_mailchamp_settings();" class="btn btn-success"><?php esc_html_e( 'Update MailChimp Setting', 'jobboard' );?></button>					
							</div>							
						</div>						
						<form class="form-horizontal" role="form"  name='mailchimp_settings' id='mailchimp_settings'>
							<div class="form-group row">
								<label  class="col-md-3 col-xs-6 col-sm-6 control-label"> <?php esc_html_e( 'MailChimp API Key :', 'jobboard' );?> </label>
								<div class="col-md-4 col-xs-6 col-sm-6">
									<?php
										$iv_mailchimp_api_key='';
										if( get_option( 'jobboard_mailchimp_api_key' )==FALSE ) {
											$iv_mailchimp_api_key = get_option('jobboard_mailchimp_api_key');						 
											}else{
											$iv_mailchimp_api_key = get_option('jobboard_mailchimp_api_key');								
										}
									?>
									<input type="text" class="form-control" id="jobboard_mailchimp_api_key" name="jobboard_mailchimp_api_key" value="<?php echo esc_html($iv_mailchimp_api_key); ?>" placeholder="">
									<a href="//admin.mailchimp.com/account/api" target="_blank"><?php  esc_html_e('Get your API key here','jobboard');?>.</a>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">	
								<label  class="col-md-3 col-xs-6 col-sm-6 control-label"><?php esc_html_e( 'Mailchimp List ', 'jobboard' );?>: </label>
								<div class="col-md-4 col-xs-6 col-sm-6">
									<?php 
										if( ! class_exists('MailChimp' ) ) {
											require_once(wp_jobboard_DIR . '/inc/MailChimp.php');
										}
										$iv_mailchimp_api_key='';
										if( get_option( 'jobboard_mailchimp_api_key' )==FALSE ) {
											$iv_mailchimp_api_key = get_option('jobboard_mailchimp_api_key');						 
										...
										echo '<select class="form-control" id="jobboard_mailchimp_list" name="jobboard_mailchimp_list">';
										if($iv_mailchimp_api_key!=''){
											$iv_form_membership_mailchimp_list=get_option( 'jobboard_mailchimp_list'); 
							...
							<div class=" col-md-7  bs-callout bs-callout-info">		
								<?php esc_html_e( 'Signup user email address will go to the mailchimp list.', 'jobboard' );?>
							</div>
