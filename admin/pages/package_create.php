	...
	<div class="dashboard-eplugin container-fluid">
		...
		<div class="row">			
			<div class="col-xs-12" id="submit-button-holder">					
				<div class="pull-right"><button class="btn btn-info btn-lg" onclick="return save_the_package();"><?php  esc_html_e('Save Package','jobboard'); ?></button></div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12"><h3 class="page-header"><?php  esc_html_e('Create Package / Membership Level','jobboard'); ?> <br /><small> &nbsp;</small> </h3>
			</div>							
		</div> 
		<form id="package_form_iv" name="package_form_iv" class="form-horizontal" role="form" onsubmit="return false;">
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" name="package_name" id="package_name" placeholder="<?php esc_html_e('Enter Package Name','jobboard');  ?> ">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6">
					...
					name="package_subtile" id="package_subtile" value="" placeholder="<?php esc_html_e('Enter Package Subtitle','jobboard'); ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="package_order" name="package_order" placeholder="<?php esc_html_e('Enter order number e.g. 1','jobboard'); ?>">
					</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6 ">
					<label>
						<input type="text" class="form-control" id="max_pst_no" value="" name="max_pst_no" placeholder="<?php esc_attr_e('Enter only number e.g. 1','jobboard'); ?>">
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6 ">
					<label>
						<input type="checkbox" name="listing_feature" id="listing_feature"  value='yes'><?php  esc_html_e('Will Add On Featured List (show on top)','jobboard'); ?>
					</label>								 										
				</div>																
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" id="package_cost" name="package_cost" placeholder="<?php esc_attr_e('Enter Initial Payment','jobboard');  ?>">
					<?php  esc_html_e('The initial amount collected at user registration.','jobboard'); ?>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6 ">
					<label>
						<input type="checkbox" name="package_recurring" id="package_recurring" value="on" > <?php  esc_html_e('Enable Recurring Payment','jobboard'); ?>
					</label>
				</div>								
			</div>
			<div id="recurring_block" class="none" >
				<?php
					if(get_option('jobboard_payment_gateway')=='stripe55555'){
					?>	
					<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-2">
						<input type="text" class="form-control" name ="package_recurring_cost_initial" id="package_recurring_cost_initial" placeholder="<?php esc_html_e('Amount','jobboard');?>">
					</div>
					<label for="text" class="col-md-1 control-label"><?php  esc_html_e('Per','jobboard'); ?></label>
					<div class="col-md-1">									
						<input type="text" class="form-control" id="package_recurring_cycle_count" name="package_recurring_cycle_count" placeholder="<?php esc_html_e('Cycle #','jobboard');?>">
					</div>
					<div class="col-md-2">
						<select name="package_recurring_cycle_type" id ="package_recurring_cycle_type" class="ctrl-combobox form-control">											
							<option value="day"><?php esc_html_e('Day(s)','jobboard');?></option>
							<option value="week"><?php esc_html_e('Week(s)','jobboard');?></option>
							<option value="month"><?php esc_html_e('Month(s)','jobboard');?></option>
							<option value="year"><?php esc_html_e('Year(s)','jobboard');?></option>
						</select>		
					</div>
					<div class='col-md-12'><label for="text" class="col-md-2 control-label"></label>
				...
				<?php
					...
					<div class="form-group">
						...
						<div class="col-md-6 ">
							<label>
								<input type="checkbox" name="package_enable_trial_period" id="package_enable_trial_period"  value='yes'> <?php  esc_html_e('Enable Trial Period','jobboard'); ?>
							</label>
							<br/>
					...
					<div id="trial_block" class="none" >
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="package_trial_amount" name="package_trial_amount" placeholder="<?php esc_attr_e('Enter Amount to Bill for The Trial Period','jobboard');?>">
		...
		<div class="row">					
			<div class="col-xs-12">					
				<div align="center">
					<div id="loading"></div>
				<button class="btn btn-info btn-lg" onclick="return save_the_package();"><?php  esc_html_e('Save Package','jobboard'); ?></button></div>
				<p>&nbsp;</p>
			</div>
		</div>
	</div>
