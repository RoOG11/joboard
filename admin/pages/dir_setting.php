...
<form class="form-horizontal" role="form"  name='directory_settings' id='directory_settings'>											
	...
	?>
	<div class="form-group">
		<label  class="col-md-3 control-label"> <?php esc_html_e('Non admin user can publish Job','jobboard');  ?></label>
		<div class="col-md-2">
			<label>												
				<input type="radio" name="user_can_publish" id="user_can_publish" value='yes' <?php echo ($user_can_publish=='yes' ? 'checked':'' ); ?> > <?php esc_html_e( 'Yes, Non Admin User can Publish', 'jobboard' );?>  
			</label>	
		</div>
		<div class="col-md-2">	
			<label>											
				<input type="radio"  name="user_can_publish" id="user_can_publish" value='no' <?php echo ($user_can_publish=='no' ? 'checked':'' );  ?> > <?php esc_html_e( 'No,Admin will approve & publish', 'jobboard' );?>
			</label>
		</div>	
	</div>
	<?php
	...
	<div class="form-group">
		...
		<div class="col-md-3">
			<?php esc_html_e( 'Cron JOB Detail : Hide Listing( Package setting),Subscription Remainder email & New listing Notifications', 'jobboard' );?>  
		</div>		
	</div>
	<div class="form-group">
		<label  class="col-md-3 control-label"> </label>
