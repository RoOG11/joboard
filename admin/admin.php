		...
		class wp_jobboard_Admin {
			...
			*/
			public function admin_menu() {
				...
				self::$pages['wp-jobboard-package-all'] = add_submenu_page('wp-jobboard', 'Package', 'Package', 'manage_options', 'wp-jobboard-package-all', array(&$this, 'menu_hook'));	
				
				self::$pages['wp-jobboard-coupons-form'] = add_submenu_page('wp-jobboard', 'WP jobboard Create', 'Coupons', 'manage_options', 'wp-jobboard-coupons-form', array(&$this, 'menu_hook'));
				self::$pages['wp-jobboard-payment-setting'] = add_submenu_page('wp-jobboard', 'WP jobboard Settings', 'Payment Gateways', 'manage_options', 'wp-jobboard-payment-settings', array(&$this, 'menu_hook'));
				add_submenu_page('wp-jobboard', 'WP jobboard', 'Payment  History', 'manage_options',  'edit.php?post_type=iv_payment');
				...
				self::$pages['wp-jobboard-package-create'] = add_submenu_page('', 'WP jobboard package', '', 'manage_options', 'wp-jobboard-package-create', array(&$this, 'package_create_page'));
				self::$pages['wp-jobboard-package-update'] = add_submenu_page('', 'WP jobboard package', '', 'manage_options', 'wp-jobboard-package-update', array(&$this, 'package_update_page'));
				self::$pages['wp-jobboard-coupon-create'] = add_submenu_page('', 'WP jobboard coupon', '', 'manage_options', 'wp-jobboard-coupon-create', array(&$this, 'coupon_create_page'));
				self::$pages['wp-jobboard-coupon-update'] = add_submenu_page('', 'WP jobboard coupon', '', 'manage_options', 'wp-jobboard-coupon-update', array(&$this, 'coupon_update_page'));
				self::$pages['wp-jobboard-payment-paypal'] = add_submenu_page('', 'WP jobboard Payment setting', '', 'manage_options', 'wp-jobboard-payment-paypal', array(&$this, 'paypal_update_page'));
				self::$pages['wp-jobboard-payment-stripe'] = add_submenu_page('', 'WP jobboard Payment setting', '', 'manage_options', 'wp-jobboard-payment-stripe', array(&$this, 'stripe_update_page'));
			...
			*/
			public function menu_hook() {
				...
				switch ($screen->id) {
					...
					break;
					case self::$pages['wp-jobboard-coupons-form']:
					...
					case self::$pages['wp-jobboard-package-all']:
					require_once ('pages/package_all.php');
					break;
					case self::$pages['wp-jobboard-payment-setting']:							
			...
			*/
			public function load_styles() {
				...
				wp_enqueue_style('bootstrap-wp-jobboard-style-2', wp_jobboard_URLPATH . 'admin/files/css/iv-bootstrap.css');
